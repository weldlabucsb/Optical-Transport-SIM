function [times,psies] = gross_pitaev_simulation(max_a,duration,omega,numstates)
...
accel = @(t) max_a - 2.*max_a.*t./duration; %linear ramp from max_a to -max_a in duration time
